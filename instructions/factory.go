...
import (
	...
	"MyJVM/instructions/comparisons"
	"MyJVM/instructions/control"
	"MyJVM/instructions/conversions"
	"MyJVM/instructions/extended"
	"MyJVM/instructions/loads"
	"MyJVM/instructions/math"
	"MyJVM/instructions/stack"
	"MyJVM/instructions/stores"
	"fmt"
)
import "MyJVM/instructions/constants"
...
func NewInstruction(opcode byte) base.Instruction {
	...
	case 0x13:
		return &extended.LDC_W{}
	case 0x14:
		return &extended.LDC2_W{}
	case 0x15:
		return &loads.ILOAD{}
	case 0x16:
		return &loads.LLOAD{}
